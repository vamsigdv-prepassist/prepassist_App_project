...
async function run() {
  ...
  console.log("Total vaultNotes:", vaultNotes.length);
  console.log("allSearchableNotes length:", allSearchableNotes.length);
  console.log("bestChunks length:", bestChunks.length);
  console.log("matchedVaultNotes length:", matchedVaultNotes.length);
}
